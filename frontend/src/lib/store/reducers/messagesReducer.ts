const plot = [
  ...
  'Какое ваше имя? (это имя будет отображаться при взаимодействии с другими пользователями)',
  'Ваша фамилия?',
  'Введите ваш email (он будет использоваться при авторизации):',
  ...
  'На этом регистрация завершена. Приятного пользования нашим приложением =) Кликните для продолжения.'
];

const driverPlot = [
  'Подготовьте, пожалуйста, ваше водительское удостоверение.',
  'Отправьте фото вашего водительского удостоверения.'
];
